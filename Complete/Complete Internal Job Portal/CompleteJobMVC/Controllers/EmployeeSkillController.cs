...
namespace EmployeeSkillMVC.Controllers
{
    ...
    {
       static EmployeeSkillClient client = new EmployeeSkillClient();
        // GET: EmployeeSkill
        [Authorize]
        public async Task<ActionResult> Index()
        {
            ...
            string role = roleName[0];
            await client.GetToken(userName, role);
        ...
        {
            List<EmpSkill> empSkills = await client.GetEmployeeSkillByEmployeeIdandSkillIdAsync(SkillId, EmpId);
            //EmpSkill empSkill = empSkills[0];
            return View(empSkills);
        }
